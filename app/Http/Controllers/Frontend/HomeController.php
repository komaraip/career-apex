...
class HomeController extends Controller
{
    ...
    function index(): View
    {
        ...
        return view('frontend.home.index', compact('hero', 'jobCategories', 'countries', 'jobCount', 'popularJobCategories', 'featuredCategories', 'whyChooseUs', 'learnMore', 'counter', 'companies', 'locations', 'reviews', 'blogs'));
    }
