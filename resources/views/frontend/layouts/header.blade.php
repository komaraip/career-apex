    ...
    <div class="mobile-header-wrapper-inner">
      <div class="mobile-header-content-area">
        <div class="perfect-scroll">
          ...
          <div class="mobile-menu-wrap mobile-header-border">
            ...
            <nav>
              <ul class="mobile-menu font-heading">
                ...
                <li class="has-children"><a href="jobs-grid.html">Find a Job</a></li>
                ...
                <li class="has-children"><a href="blog-grid.html">Pages</a></li>
          ...
          <div class="site-copyright">Copyright 2024 &copy; Career Apex.</div>
        </div>
      </div>
    </div>
  </div>
